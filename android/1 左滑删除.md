...
```xml
<com.better.appbase.view.SwipeMenuLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <TextView
        ...
        android:layout_width="@dimen/sx_dp70"
...
</com.better.appbase.view.SwipeMenuLayout>
```