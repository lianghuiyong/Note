...
![](https://github.com/gelitenight/WaveView/blob/master/screenshot.gif)
...
public class WaveHelper {
    ...
    private void initAnimation() {
        ...
        ObjectAnimator amplitudeAnim = ObjectAnimator.ofFloat(
                mWaveView, "amplitudeRatio", 0.0001f, mWaveView.getAmplitudeRatio());
...
```
    ...
    public void onBackPressed() {
        super.onBackPressed();
        waveHelper.stopAnimation();
    }

    private void initView() {
        waveHelper = new WaveHelper(waveView);
        waveView.setBorder(0, Color.parseColor("#c5af92"));
        waveView.setWaveColor(Color.parseColor("#bfa689"), Color.parseColor("#c5af92"));
